import { Box, Heading, VStack, HStack, Link, Input, FormControl, FormLabel, Button, Icon, Text, Image} from "@chakra-ui/react";
...
function Footer() {
  ...
  return (
    <Box as="footer" bg="rgba(3, 27, 29, 1)" textAlign="center" py="50px">
      <Heading as="h4" color="#dfe22f" mb="20px">
        Visitame
      </Heading>
      <HStack className="footer-content" justify="space-between" w="95%" mx="auto" align="flex-start">
        <VStack className="Contenedor-text" align="flex-start" pl="5%">
          <HStack className="Columnas" spacing={10}>
            <VStack className="Tec" align="flex-start" color="White">
              <Heading as="h4" size="md" color="#dfe22f">
                Personalidad
              </Heading>
              <Text>Seguridad</Text>
        ...
        <VStack className="contact" align="flex-start" pr="10px" pb="40px" w="400px">
          <Heading as="h4" size="md" color="#dfe22f" mb="20px">
            Contactame
          </Heading>
          <form>
            <HStack className="name" spacing={4} w="100%">
              <Input type="text" placeholder="Nombre" bg="rgba(3, 27, 29, 1)" border="1px solid #dfe22f" color="#dfe22f" textAlign="center" _hover={{ bg: "#dfe22f", color: "rgba(3, 27, 29, 1)" }} />
              <Input type="text" placeholder="Apellido" bg="rgba(3, 27, 29, 1)" border="1px solid #dfe22f" color="#dfe22f" textAlign="center" _hover={{ bg: "#dfe22f", color: "rgba(3, 27, 29, 1)" }} />
            </HStack>
            <Input type="email" placeholder="Email" mt={4} bg="rgba(3, 27, 29, 1)" border="1px solid #dfe22f" color="#dfe22f" textAlign="center" _hover={{ bg: "#dfe22f", color: "rgba(3, 27, 29, 1)" }} />
