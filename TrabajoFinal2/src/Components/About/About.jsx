  ...
  return (
    <Box as="section" id="about" p="10px 10px 10px 0" bg="rgba(3,27,29,255)" fontFamily='Times New Roman'>  
      <Flex mt="5%" w="100%">
        ...
        <Box className="about-text" mt="0" pt="0" ml="20px" display="flex" flexDirection="column" w="70%">
          <Heading as="h2" color="#dfe22f" textAlign="left" fontFamily='Times New Roman'>
            Sobre Mi
          </Heading>
          <Tabs>
            <TabList borderBottom='none' as="h3" color="white" fontSize="18px" gap="30px" >
            ...
            <TabPanels color="#a39ba3" fontSize="14px" textAlign="left" width="70%" >
              <TabPanel>
